...
Если вложенных форм несколько то они циклично чередуются по порядку.

Каждая форма имеет своего парента в виде основной зоны плитки и может быть трансформирована относительно него
