...
def value_to_data(value: str) -> [str, str]:
...
def file_to_b64_value(file_path: str) -> str:
    with open(file_path, 'rb') as f:
        base64_str = base64.b64encode(f.read()).decode('utf-8')
    return f'base64::{Path(file_path).name}::{base64_str}'


def file_to_b64_str(file_path: str) -> str:
    with open(file_path, 'rb') as f:
        base64_str = base64.b64encode(f.read()).decode('utf-8')
    return base64_str


def b64_str_to_file(base64_str: str) -> bytes:
